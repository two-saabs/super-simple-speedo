...
function applyPositiveOnboarding(html) {
  ...
  html.frenano-first-run .frenano-location-intro .location-intro-detail { margin-top:18px; }
  html.frenano-first-run .frenano-location-intro .location-intro-core h1 { margin:12px 0 0; font-size:clamp(42px,11vw,54px); line-height:.96; text-align:left; align-self:flex-start; letter-spacing:-.055em; }
  .swiss-mark { font-size:.58em; vertical-align:.08em; }
  html.frenano-first-run .frenano-location-intro .location-intro-lead { margin:14px 0 0; max-width:390px; text-align:left; align-self:flex-start; font-size:16px; }
  ...
  @media(max-height:760px){ html.frenano-first-run .frenano-location-intro .location-intro-detail{margin-top:10px}html.frenano-first-run .frenano-location-intro .location-intro-core h1{font-size:38px}.location-intro-promises{margin-top:12px;gap:6px 14px}.location-intro-promises div{padding:7px 0}.location-intro-permission{margin-top:10px;padding:10px 12px}.location-intro-guidance{margin-top:8px;font-size:11px}html.frenano-first-run .frenano-location-intro .location-enable-button{margin-top:10px} }
  </style>`;
