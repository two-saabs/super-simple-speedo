...
function applyPositiveOnboarding(html) {
  ...
  const css = `<style id="positive-onboarding-v4">
  ...
  .location-intro-promises div { min-height:58px; padding:10px 0; border-top:1px solid rgba(255,255,255,.16); display:flex; flex-direction:column; justify-content:flex-start; }
