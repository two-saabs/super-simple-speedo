function applySimpleStartup(html) {
  ...
  // Brand refresh runs before this transform, so the intro uses Frenano's real
  // launch artwork rather than a generated or mock logo.
  ...
  <div class="location-intro-core">
    <div class="location-intro-brand" aria-label="Frenano">
      <img class="location-intro-logo" src="/images/frenano-startup-logo-512.png?v=20260911-frenano-location-v3" alt="">
    ...
    <div class="location-intro-reasons">
      <div class="location-intro-reason">
        ...
        <div><strong>Accurate speed</strong><span>Calculated from GPS in real time.</span></div>
      </div>
      <div class="location-intro-reason">
        <div class="location-intro-icon" aria-hidden="true">⌾</div>
        <div><strong>Privacy focused</strong><span>No tracking, ads or location history.</span></div>
      </div>
    </div>
