...
function applyHelpContactPrivacyFix(html, replaceRequiredSnippet, { appVersion, buildChannel }) {
  html = replaceRequiredSnippet(
    ...
    '<div class="settings-section-title">Help & privacy</div>',
    'index.template.html'
  );
  ...
  const publicPrivacyUrl = 'https://supersimplespeedo.app/#privacy';
