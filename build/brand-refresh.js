function applyBrandRefresh(html) {
  ...
  html = html.replace('<link rel="icon" type="image/png" sizes="192x192" href="/icons/icon-192.png">', `<link rel="icon" type="image/png" href="${approvedMark}">`);
  html = html.replace('<link rel="apple-touch-icon" href="/icons/icon-192.png">', `<link rel="apple-touch-icon" href="${approvedMark}">`);
