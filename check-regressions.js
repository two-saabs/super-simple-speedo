...
const contracts = [
  ...
  ['transport metrics node remains available for diagnostic contracts', /id=["']transportMetrics["']/],
  ['front screen uses simple vehicle detector label', /Vehicle detector:/],
  ['front screen uses simple line detector label', /Line detector:/],
  ['front screen hides detailed transport metrics', /#transportMetrics\s*\{\s*display:\s*none\s*!important;/s],
