function applyBrandRefresh(html) {
  ...
  const css = `\n<style id="brand-refresh-v6">\n  .launch-brand { display:grid; justify-items:center; gap:12px; margin:0 auto 24px; text-align:center; }\n  .launch-brand-icon { width:154px; display:grid; place-items:center; background:transparent; border:0; box-shadow:0 22px 58px rgba(0,0,0,.30); }\n  .launch-brand-mark { width:154px; height:auto; display:block; }\n  .launch-brand-name { margin-top:4px; display:grid; justify-items:center; gap:0; color:#fff; font-size:28px; line-height:.98; font-weight:780; letter-spacing:-.04em; }\n  .launch-brand-name strong { font-size:37px; font-weight:900; }\n  .launch-brand-tagline { margin-top:8px; max-width:300px; color:#a4a4a4; font-size:15px; line-height:1.35; font-weight:650; letter-spacing:-.01em; }\n\n  .app-title.app-brand-lockup { min-width:176px; min-height:58px; display:flex; align-items:center; gap:11px; opacity:1; visibility:visible; text-transform:none !important; letter-spacing:normal !important; }\n  .app-brand-mark { width:58px; height:58px; flex:0 0 58px; display:block; }\n  .app-brand-name { display:grid; grid-template-columns:max-content; gap:0; color:#fff; line-height:.94; text-transform:none !important; text-align:left; }\n  .app-brand-name > span, .app-brand-name > strong { display:block; width:100%; box-sizing:border-box; }\n  .app-brand-name > span { font-size:16px; font-weight:760; letter-spacing:-.055em; transform:scaleX(.92); transform-origin:left center; }\n  .app-brand-name > strong { font-size:20px; font-weight:900; letter-spacing:-.055em; }\n  /* Keep the compact website-style rectangular wordmark: Super Simple aligns visually with Speedo below. */\n  /* Let the parent header's driver-mode opacity dim the logo exactly like the settings button. */\n  body.driver-mode .app-title.app-brand-lockup { opacity:1; visibility:visible; transition:opacity .55s ease; }\n</style>`;
