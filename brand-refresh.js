function applyBrandRefresh(html) {
  ...
  const runningAfter = `    <div class="app-title" aria-label="Super Simple Speedo"><img class="app-brand-mark" src="${approvedMark}" alt=""><span class="app-brand-name">Super Simple Speedo</span></div>`;
